    ...
    private fun readOwner(jsonReader: JsonReader): Owner {
        ...
        while (jsonReader.hasNext()) {
            ...
            when (name) {
                ...
                "id" -> owner.ownerId = jsonReader.nextInt()
                ...
                "url" -> owner.ownerUrl = jsonReader.nextString()
                "html_url" -> owner.ownerHtmlUrl = jsonReader.nextString()
                ...
                "events_url" -> owner.ownerEventsUrl = jsonReader.nextString()
